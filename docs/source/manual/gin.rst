...
::
    ...
    'adabound' - neural_toolkits.optim.AdaBound
    ...
    'lookahead' - neural_toolkits.optim.Lookahead
    'nadam' - neural_toolkits.optim.NAdam
...
::
    ...
    'inverse_lr' - neural_toolkits.optim.lr_scheduler.InverseLR
    'warm_restart' - neural_toolkits.optim.lr_scheduler.WarmRestart
